...
def lodestar_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:4AEXg2qx+/w29jXnXpMY6mTckmYu1TMoHteKuMf0HFg=",
        version = "v1.8.9",
    )
...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:SRdWLg+DqMFWX8HB3UvXyAoZpw9IDIUYnSTwgzOYbqg=",
        version = "v1.37.18",
    )
    go_repository(
        name = "com_github_azure_azure_sdk_for_go",
        importpath = "github.com/Azure/azure-sdk-for-go",
        sum = "h1:kZFnTLmdQYNGfakatSivKHUfUnDZhqNdchHD4oIhp5k=",
        version = "v31.2.0+incompatible",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XANm4xAMEQhRdWKqaL0qmhGDv7RuobwCO97TIlktaQE=",
        version = "v3.0.0-20210107172259-749611fa9fcc",
    )
    go_repository(
        name = "io_filippo_age",
        importpath = "filippo.io/age",
        sum = "h1:RZiSK+N3KL2UwT82xiCavjYw8jJHzWMEUYePAukTpk0=",
        version = "v1.0.0-beta7",
    )
    go_repository(
        name = "io_filippo_edwards25519",
        importpath = "filippo.io/edwards25519",
        sum = "h1:EWbZLqGEPSIj2W69gx04KtNVkyPIfe3uj0DhDQJonbQ=",
    ...
    go_repository(
        ...
        sum = "h1:8+hqYKtjqC1ODqBxJUZoJ0WIcv6VBwY4LGZOO1jONtk=",
        version = "v3.7.1",
    )
    go_repository(
        name = "tools_gotest",
